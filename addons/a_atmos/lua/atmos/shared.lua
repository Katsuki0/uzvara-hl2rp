...
atmos_dnc_length_day = CreateConVar( "atmos_dnc_length_day", "1500", bit.bor( FCVAR_ARCHIVE, FCVAR_GAMEDLL, FCVAR_REPLICATED ), "The duration modifier of daytime in seconds." );
atmos_dnc_length_night = CreateConVar( "atmos_dnc_length_night", "1500", bit.bor( FCVAR_ARCHIVE, FCVAR_GAMEDLL, FCVAR_REPLICATED ), "The duration modifier of nighttime in seconds." );
