	...
	if (target != "") then
		...
		if (IsValid(target)) then
			...
			if (target == player) then
				atlaschat.Notify("Успешно сбросил конфигурацию atlaschat! Закройте и откройте окно чата, чтобы применить.", target)
			else
				atlaschat.Notify(player:Nick() .. " сбросил конфигурацию atlaschat! Закройте и откройте окно чата, чтобы применить.", target)
				atlaschat.Notify("Вы сбросили " .. target:Nick() .. "'atlaschat конфигурации! Закройте и откройте окно чата, чтобы применить.", player)
			end
		end
	else
		if (player:IsAdmin()) then
			...
			atlaschat.Notify(player:Nick() .. " сбросил все настройки atlaschat! Закройте и откройте окно чата, чтобы применить.")
		end
	end
end)
