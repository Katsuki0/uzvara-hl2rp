...
function ENT:Initialize()
	...
	self.mortarmodel = ents.Create("prop_physics")
	self.mortarmodel:SetKeyValue("StartDisabled", "0")
	self.mortarmodel:SetKeyValue("solid", "6")
	self.mortarmodel:SetKeyValue("model", "models/props_lab/reciever01b.mdl")
	self.mortarmodel:SetKeyValue( "targetname", tostring(self.mortarmodel) )
	self.mortarmodel:SetPos(self:GetPos() + Vector(0,0,0))
	...
	self.mortar:SetKeyValue("bullet_damage" , "100")
	self.mortar:SetKeyValue("bullet_damage_vs_player" , "100")
