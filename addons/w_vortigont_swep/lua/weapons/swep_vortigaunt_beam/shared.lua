...
if ( CLIENT ) then
	SWEP.DrawAmmo			= true
	SWEP.PrintName			= "Оружие Вортигонта"
	SWEP.Author				= "Jvs"
...
SWEP.MaxArmor				= 10	//used for the math.random
SWEP.MinArmor				= 10	//"		"	"	"
SWEP.ArmorLimit				= 100	//100 is the default hl2 armor limit
SWEP.BeamDamage				= 90	//25 is done by one zap attack,since vortigaunt has two claws,50 dmg,
...
SWEP.Primary.DefaultClip	= 2500		//give the poor user 25 combine balls to have fun with this wepon
