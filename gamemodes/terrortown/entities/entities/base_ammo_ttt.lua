...
function ENT:Touch(ent)
   if (SERVER and self.tickRemoval ~= true) then
    if ent:IsValid() and blackListedEnts[ent:GetClass()] then return end
    if ent:IsValid() and ent:IsPlayer() then 
      if self:CheckForWeapon(ent) and self:PlayerCanPickup(ent) then
