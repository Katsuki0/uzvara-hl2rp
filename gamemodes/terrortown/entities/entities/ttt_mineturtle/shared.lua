...
if SERVER then
   function ENT:Think()	
	local playersnear = 0
			...
			if (ent:IsPlayer() and ent:IsSpec()) then return end
			if (ent:IsPlayer() and ent:GetRole() == 0 or ent:IsPlayer() and ent:GetRole() == 2) then
			...
			local tr = util.TraceLine({
				...
				if (!tr.HitWorld and distance < (self.Range) and ent:Alive()) then
