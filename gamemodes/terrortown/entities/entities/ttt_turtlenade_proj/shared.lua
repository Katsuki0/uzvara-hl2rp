...
TurtleInnocentDamage  = 50
TurtleTraitorDamage   = 50
...
function SpawnNPC( Player, Position, Class )
	...
	for _,traitors in pairs (player.GetAll()) do
		NPC:AddEntityRelationship( traitors, D_HT, 99 )
		if traitors:IsActiveTraitor() then
			NPC:AddEntityRelationship( traitors, D_FR, 99 )
		end
