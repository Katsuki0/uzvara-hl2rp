...
function SWEP:PrimaryAttack()
    ...
    ply:SetColor(Color(255,0,0,255))
          ...
          timer.Create("GivePlyHealth_"..self.Owner:UniqueID(),0.5,5,function() self.Owner:SetHealth(self.Owner:Health()+10) end)
...
SWEP.Icon = "materials/typical_ttt/canibal.png"

-- Text shown in the equip menu
SWEP.EquipMenuData = {
	type = "Weapon",
	desc = "Кушайте трупы и пополняйте здоровье!"
};
end