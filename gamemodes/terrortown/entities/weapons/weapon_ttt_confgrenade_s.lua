...
if SERVER then
	resource.AddWorkshop("481692085")
end

if CLIENT then
   SWEP.PrintName = "Супер дискамбулятор"
   SWEP.Slot = 7

   SWEP.EquipMenuData = {
      type = "Супер Дискамбулятор",
      desc = "Просто чу-чуть больше чем дискамбуль'".."\n".."А ТЕПЕРЬ ЕЩЕ БОЛЬШЕ ОТТАЛКИВАНИЯ"
   };
