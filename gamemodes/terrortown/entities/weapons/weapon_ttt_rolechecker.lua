...
if CLIENT then
   SWEP.PrintName           = "Проверка роли игрока"
   SWEP.Slot                = 6
   ...
   SWEP.EquipMenuData = {
      type = "item_weapon",
      desc = "Проверяет роль игрока.\nЕсли куб красный - предатель\nЗеленый - невиновный"
   };

   SWEP.Icon                = "typical_ttt/tester.png"
end
...
function SWEP:DropDevice()
   ...
   if SERVER then
      ...
      cse = ents.Create("ttt_rolechecker")
      if IsValid(cse) then
