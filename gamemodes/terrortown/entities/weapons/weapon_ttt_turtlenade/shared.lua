...
if CLIENT then
   ...
   -- Text shown in the equip menu
	SWEP.EquipMenuData = {
		...
		type = "Weapon",
		desc = "Черепашья лошвука.\n Нажмите ПКМ для того что-бы поставить черепашку, после чего она взорвется."
   };
