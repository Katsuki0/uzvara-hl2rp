...
SWEP.old_Cone           = SWEP.Primary.Cone 
...
if CLIENT then
   ...
   function SWEP:DrawHUD()
      ...
      if self.Primary.Rifle == true then return end
...
function SWEP:PrimaryAttack(worldsnd)
   ...
   self.Primary.Cone = self.old_Cone
end
...
function SWEP:SetIronsights(b)
   ...
   if (b == true) and o:IsValid() then
      o:SetWalkSpeed(90)
      o:SetSlowWalkSpeed(90)
   elseif (b == false) and o:IsValid() then
      o:SetWalkSpeed(220)
      o:SetSlowWalkSpeed(100)
   end
end
