...
function GM:HUDDrawTargetID()
   ...
   if ent:GetClass() == "npc_turret_floor" and ent:GetNWBool("IsDetectiveTurret") then
      
      surface.SetTexture(ring_tex)
      
      surface.SetDrawColor(0, 0, 255, 220)
      
      surface.DrawTexturedRect((ScrW() / 2.0) - 32,  (ScrH() / 2.0) - 32, 64, 64)
   end
   ...
   if ent:IsPlayer() and KARMA.IsEnabled() then
      text, clr = util.KarmaToString(ent:GetBaseKarma() or 1000)
