...
if CLIENT then
   ...
   function util.KarmaToString(karma)
      ...
      if tonumber(karma) > maxkarma * 0.89 then
         return "karma_max", karmacolors.max
      elseif tonumber(karma) > maxkarma * 0.8 then
         return "karma_high", karmacolors.high
      elseif tonumber(karma) > maxkarma * 0.65 then
         return "karma_med", karmacolors.med
      elseif tonumber(karma) > maxkarma * 0.5 then
