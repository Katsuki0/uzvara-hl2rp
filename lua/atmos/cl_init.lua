...
local function AtmosSettings( CPanel )
	...
	CPanel.weatherlength = CPanel:AddControl( "Slider", { Label = "#atmos.weatherlength", Type = "Int", Min = 0, Max = 3200, Help = true } );
	...
	CPanel.weatherdelay = CPanel:AddControl( "Slider", { Label = "#atmos.weatherdelay", Type = "Int", Min = 60, Max = 3200, Help = true } );
