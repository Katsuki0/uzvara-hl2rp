...
concommand.Add( "atmos_startstorm", function( pl, cmd, args )
	...
	AtmosMessageAll( Color( 255, 153, 0 ), "[atmos] ", Color( 255, 255, 255 ), string.format( "%s has started a storm.", (IsValid( pl ) and pl:Nick() or "Console") ) ); -- цвет в чате когда начинаешь шторм
...
concommand.Add( "atmos_stopstorm", function( pl, cmd, args )
	...
	AtmosMessageAll( Color( 255, 153, 0 ), "[atmos] ", Color( 255, 255, 255 ), string.format( "%s has stopped a storm.", (IsValid( pl ) and pl:Nick() or "Console") ) ); -- тоже шторм
...
concommand.Add( "atmos_startsnow", function( pl, cmd, args )
	...
	AtmosMessageAll( Color( 255, 153, 0 ), "[atmos] ", Color( 255, 255, 255 ), string.format( "%s has started a snow storm.", (IsValid( pl ) and pl:Nick() or "Console") ) ); -- тоже шторм
...
concommand.Add( "atmos_stopsnow", function( pl, cmd, args )
	...
	AtmosMessageAll( Color( 255, 153, 0 ), "[atmos] ", Color( 255, 255, 255 ), string.format( "%s has stopped a snow storm.", (IsValid( pl ) and pl:Nick() or "Console") ) ); -- и ещё один шторм
