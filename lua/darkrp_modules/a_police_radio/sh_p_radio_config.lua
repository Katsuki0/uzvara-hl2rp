...
Police_Radio_Config["HUD_Text_On"] =  "Голос включен(%s)" --The text that appears above the radio icon if enabled (Set to "" to disable text)
Police_Radio_Config["HUD_Text_Off"] = "Голос выключен(%s)" --If the radio is disabled this text will appear (choose "" to disable text)
Police_Radio_Config["HUD_Text_On_Receive"] =  "Радио включено(%s)" --The text that appears above the radio icon if their received audio is disabled (Set to "" to disable text)
Police_Radio_Config["HUD_Text_Off_Receive"] = "Радио выключено(%s)" --If the received audio is disabled this text will appear (choose "" to disable text)
