...
net.Receive("police_radio_toggle",function(len,ply)
	if Police_Radio_Config["Allow_Teams"][ply:getJobTable().command] or ply:isCP() then
...
DarkRP.defineChatCommand("giveradio",function(ply,args)
	...
	if not ply:IsAdmin() then ply:ChatPrint("You have insufficient permissions to use this!") return "" end
