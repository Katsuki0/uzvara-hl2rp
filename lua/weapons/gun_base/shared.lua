...
SWEP.Primary.Force          = 40                        -- Should be the same value as in the other scripts (m9k_combinesniper)
...
function SWEP:Deploy()
	...
	self.Weapon:EmitSound("weapons/combinesniper_e2/ep2sniper_deploy.wav")
...
function SWEP:PrimaryAttack()
	...
	if !self.Owner:KeyDown(IN_SPEED) and !self.Owner:KeyDown(IN_RELOAD) then
		...
		if self.Silenced then
			...
			self.Weapon:EmitSound("weapons/combinesniper_e2/ep2sniper_fire.wav")
		end	
...
---------------------------------------------------------*/
local TracerName = "AR2Tracer"  -- Original: Tracer
...
function SWEP:ShootBullet(damage, recoil, num_bullets, aimcone)
	...
	if self.Tracer == 1 then
		TracerName = "AR2Tracer" -- Original: Ar2Tracer
	elseif self.Tracer == 2 then
		TracerName = "AirboatGunHeavyTracer"
	else
		TracerName = "AR2Tracer" -- Original: Tracer
	end
