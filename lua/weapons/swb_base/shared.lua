...
SWEP.FireModeNames = {["auto"] = {display = "", auto = true, burstamt = 0, buldis = 5},
	["semi"] = {display = "", auto = false, burstamt = 0, buldis = 1},
	["double"] = {display = "", auto = false, burstamt = 0, buldis = 1},
	["bolt"] = {display = "", auto = false, burstamt = 0, buldis = 1},
	["pump"] = {display = "", auto = false, burstamt = 0, buldis = 1},
	["break"] = {display = "", auto = false, burstamt = 0, buldis = 1},
	["2burst"] = {display = "", auto = true, burstamt = 2, buldis = 2},
	["3burst"] = {display = "", auto = true, burstamt = 3, buldis = 3},
